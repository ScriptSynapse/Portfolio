...
export function Contact() {
  ...
  const submitMagnet = useMagneticHover<HTMLButtonElement>(0.2);
          ...
          <div className="mt-10 grid lg:grid-cols-2 gap-14">
            ...
            <form onSubmit={onSubmit} noValidate className="flex flex-col gap-5">
              ...
              <motion.button
                  ...
                  style={submitMagnet.style}
                  onMouseMove={submitMagnet.onMouseMove}
                  onMouseLeave={submitMagnet.onMouseLeave}
                  type="submit"
                  disabled={state === "sending"}
                  className="sheen glow-hover group relative overflow-hidden inline-flex items-center justify-center gap-2 bg-red text-ink px-6 py-3.5 text-mono text-xs tracking-[0.2em] disabled:opacity-60"
              >
