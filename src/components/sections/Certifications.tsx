        ...
        <section id="certifications" className="relative py-24 sm:py-32 border-t border-line">
            <div className="mx-auto max-w-7xl px-5 sm:px-8">
                ...
                <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    {certifications.map((cert, i) => (
                        <motion.div
                            ...
                            className="glow-hover group relative border border-line hover:border-line-strong transition-colors duration-200 p-6 bg-carbon"
                        >
                ...
                <span className="relative flex h-9 w-9 items-center justify-center shrink-0">
                  <span className="absolute inset-0 rounded-full border border-dashed border-red/40 animate-spin [animation-duration:9s]" />
                  <Award size={18} className="relative text-red" />
                </span>
