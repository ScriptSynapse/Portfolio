...
export function Hero() {
  const primaryMagnet = useMagneticHover<HTMLAnchorElement>(0.25);
  const secondaryMagnet = useMagneticHover<HTMLAnchorElement>(0.2);
      ...
      <section id="home" className="relative min-h-[100svh] flex flex-col justify-center overflow-hidden pt-24 pb-16">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-5 sm:px-8 grid lg:grid-cols-[1fr_auto] gap-12 items-end">
          <div>
            ...
            <h1 className="text-display font-bold leading-[0.88] text-ink">
              ...
              <motion.span
                  ...
                  className="block text-[15vw] sm:text-[11vw] lg:text-[7.5vw] text-red drop-shadow-[0_0_50px_rgba(227,6,19,0.35)]"
              >
            ...
            >
              <motion.a
                  ...
                  className="sheen glow-hover group relative overflow-hidden inline-flex items-center gap-2 bg-red text-ink px-6 py-3 text-mono text-xs tracking-[0.2em]"
              >
              ...
              <motion.a
                  ...
                  download
                  className="sheen group relative inline-flex items-center gap-2 border border-line-strong px-6 py-3 text-mono text-xs tracking-[0.2em] text-ink hover:border-red transition-colors duration-200"
              >
                DOWNLOAD RESUME
          ...
          <motion.aside
              ...
              className="w-full lg:w-72 border border-line bg-surface/60 backdrop-blur-sm p-5 text-mono text-xs tracking-wider shadow-[0_30px_80px_-30px_rgba(0,0,0,0.7)]"
          >
